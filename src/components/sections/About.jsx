...
export const About = () => {
  ...
  const contributions = [
    ...
    {
      title: "City of Hagerstown [UNRELEASED]",
      thumbnail:
        "https://tr.rbxcdn.com/180DAY-9e125f095068fc5d517966d39951bf18/150/150/Image/Webp/noFilter",
      url: "https://www.roblox.com/communities/352964112/City-of-Hagerstown#!/about",
      views: 0,
    },
  ];
        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="rounded-xl p-8 border-white/10 border hover:-translate-y-1 transition-all">
            <p className="text-gray-300 mb-6">
              I’m Toby — a dedicated Roblox developer with 4+ years of
              ...
              <div className="space-y-4 text-gray-300">
                <div>
                  <h4 className="font-semibold">
                    <strong>Lead Scripter</strong> – <strong>AdrenaLane</strong>{" "}
                    (2021 – Present)
                    <p>
                      Sole developer responsible for all scripting, gameplay
                      systems, and live updates on a title that has surpassed
                      770,000 plays. Designed and shipped every core mechanic
                      from the ground up.
                    </p>
                  </h4>
                </div>
                <div>
                  <h4 className="font-semibold">
                    ...
                    <strong>Commission Work</strong>
                    <p>
                      Delivered custom scripting solutions for multiple paying
                      clients — quest systems, movement frameworks, UI suites,
                      dungeon AI, and bug-fix engagements. See the Projects
